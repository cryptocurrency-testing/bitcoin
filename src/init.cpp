...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-zmqrawtxonlymempool", strprintf("Disable transaction notification for BlockConnect and BlockDisconnect signals"), ArgsManager::ALLOW_ANY, OptionsCategory::ZMQ);
#else
